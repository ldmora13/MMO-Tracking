...
const Login = () => {
  ...
  return (
    <div className='h-screen w-screen flex flex-items justify-center overflow-hidden bg-[#171717]'>
        <header className='flex absolute top-10 sm:top-25 w-full justify-center items-center'>
          <div className='rounded-4xl border-[0.5px] border-white flex justify-between backdrop-blur-2xl h-15 w-[400px] sm:w-[600px] md:w-[800px] p-4'>
            <div className='flex flex-row gap-2 '>
              <svg fill="#ffffff" viewBox="0 0 35.632 35.632">
