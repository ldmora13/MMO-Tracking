  ...
  return (
    <div className='h-screen w-screen flex flex-items justify-center overflow-hidden bg-[#171717]'>
        <header className='flex absolute top-10 sm:top-25 w-full justify-center items-center z-[1000]'>
          <div className='rounded-4xl border-[0.5px] border-white flex justify-between bg-[#ffffff0e] backdrop-blur-sm h-15 w-[400px] sm:w-[600px] md:w-[800px] p-4'>
        ...
        <div className='flex absolute top-100 sm:top-100 w-full justify-center items-center z-[999] '>
          <div onClick={handleHome}
           className='rounded-4xl border-[0.5px] border-white shadow-sm backdrop-blur-sm hover:backdrop-blur-4xl cursor-pointer h-15 w-[150px] p-2 bg-[#ffffff0e]'>
